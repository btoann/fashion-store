    ...
    <div class="col-lg-4">
      <div class="card pd-40 tx-center">
        <div class="d-flex justify-content-center mg-b-30">
          <img src="resources/img/icon1.svg" class="wd-100" alt="">
        </div>
      ...
      <div class="card mg-t-20">
        ...
        <div class="list-group list-group-flush">
          <div class="list-group-item">
            <div class="media">
              <img src="resources/img/img1.jpg" class="wd-30 rounded-circle" alt="">
          ...
          <div class="list-group-item">
            <div class="media">
              <img src="resources/img/img2.jpg" class="wd-30 rounded-circle" alt="">
              <div class="media-body mg-l-10">
          ...
          <div class="list-group-item">
            <div class="media">
              <img src="resources/img/img4.jpg" class="wd-30 rounded-circle" alt="">
              <div class="media-body mg-l-10">
