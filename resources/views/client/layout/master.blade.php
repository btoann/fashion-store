...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="stylesheet" href="resources/client/css/ion.rangeSlider.css" type="text/css">
        <link rel="stylesheet" href="resources/client/css/ion.rangeSlider.skinFlat.css" type="text/css">
        <link rel="stylesheet" href="resources/client/css/jquery.bxslider.css" type="text/css">
        <link rel="stylesheet" href="resources/client/css/jquery.fancybox.css" type="text/css">
        <link rel="stylesheet" href="resources/client/css/flexslider.css" type="text/css">
        <link rel="stylesheet" href="resources/client/css/swiper.css" type="text/css">
        <link rel="stylesheet" href="resources/client/css/style.css" type="text/css">
        <link rel="stylesheet" href="resources/client/css/media.css" type="text/css">
        <link rel="stylesheet" href="resources/client/css/style-2.css" type="text/css">

        <script src="resources/client/js/jquery-1.11.2.min.js"></script>
    ...
    <header class="header">
        ...
        <div class="header_top">
            <div class="container">
                <ul class="contactinfo nav nav-pills">
                    ...
                    <li>
                        <i class="fa fa-envelope"></i> toannbps12879@fpt.edu.vn
                    </li>
                </ul>
                <!-- Social links -->
                <ul class="social-icons nav navbar-nav">
                    ...
                    <li>
                        <a href="./administrator" rel="nofollow" target="_blank">
        ...
        <div class="header-middle">
            <div class="container header-middle-cont">
                <div class="toplogo">
                    <a href="./">
                        <img src="resources/img/logo.png" alt="AllStore - MultiConcept eCommerce Template">
                    </a>
                </div>
                <div class="shop-menu">
                    <ul>
                        ...
                        <li>
                            <div class="h-cart">
                                <a href="{{ route('cart') }}">
                                    ...
                                    (<b>{{ (Session()->has('loginId')) ? Cart::count() : 0 }}</b>)
                                </a>
                            </div>
                        </li>
                        ...
                        @else
                            <li class="topauth">
                                <a href="{{ route('profile') }}">
                                    <i class="fa fa-user"></i>
                                    <span class="shop-menu-ttl">Profile</span>
                                </a>
                            </li>
                            <li class="topauth">
                                <span class="shop-menu-ttl">
                                    <form action="{{ route('logout') }}" method="post">
                                        @csrf
                                        <input type="hidden" name="id" value="{{ Session()->get('loginId') }}">
                ...
                <nav class="topmenu">
                    ...
                    <ul class="mainmenu">
                        ...
                        <li class="menu-item-has-children">
                            <a href="./category" class="{{ (request()->segment(1) == 'category') ? 'active' : '' }}">
                        ...
                        <li class="menu-item-has-children">
                            <a href=".\blog" class="{{ (request()->segment(1) == 'blog') ? 'active' : '' }}">
...
@yield('body')
            ...
            <div class="container">
                <div class="row">
                    <div class="companyinfo">
                        <a href="./">
                            <img src="resources/img/logo-b.png" alt="AllStore">
                            AllStore - All the good clothes will belong to you
                        </a>
                    </div>
                    ...
                    <div class="stylization f-block-modal f-block-modal-map" id="f-block-modal-4">
                        <div class="allstore-gmap">
                            <div class="marker" data-zoom="15" data-lat="-37.81485261872975" data-lng="144.95655298233032" data-marker="resources/img/marker.png">534-540 Little Bourke St, Melbourne VIC 3000, Australia</div>
                        </div>
                    </div>
                    <div class="f-delivery">
                        <img src="resources/img/vietnam-map.png" alt="">
                        <h4>Free delivery in Vietnam</h4>
    ...
    <script src="resources/client/js/jquery-1.11.2.min.js"></script>
    <script src="resources/client/js/jquery.bxslider.min.js"></script>
    <script src="resources/client/js/fancybox/fancybox.js"></script>
    <script src="resources/client/js/fancybox/helpers/jquery.fancybox-thumbs.js"></script>
    <script src="resources/client/js/jquery.flexslider-min.js"></script>
    <script src="resources/client/js/swiper.jquery.min.js"></script>
    <script src="resources/client/js/jquery.waypoints.min.js"></script>
    <script src="resources/client/js/progressbar.min.js"></script>
    <script src="resources/client/js/ion.rangeSlider.min.js"></script>
    <script src="resources/client/js/chosen.jquery.min.js"></script>
    <script src="resources/client/js/jQuery.Brazzers-Carousel.js"></script>
    <script src="resources/client/js/plugins.js"></script>
    <script src="resources/server/lib/sweetalert/sweetalert.min.js"></script>
    <script src="resources/client/js/main.js"></script>
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDhAYvx0GmLyN5hlf6Uv_e9pPvUT3YpozE"></script>
    <script src="resources/client/js/gmap.js"></script>
