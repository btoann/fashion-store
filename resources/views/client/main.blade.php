...
<main>
    ...
    @if (Session()->has('access_fail'))
        <span data-alert="{{ Session()->get('access_fail') }}" id="alert"></span>
        <script>
            $(document).ready(function () {
                let alert = $('#alert').attr('data-alert');;
                swal("Deny access", alert, "warning");
            });
        </script>
        @php
    ...
    <section class="container">
        ...
        <div class="fr-slider-wrap">
            <div class="fr-slider">
                <ul class="slides">
                    <li>
                        <img src="resources/img/slider/slide1.jpg" alt="">
        ...
        <div class="fr-pop-wrap">
            ...
            <ul class="fr-pop-tabs sections-show">
                ...
                <li><a data-frpoptab-num="2" data-frpoptab="#frpoptab-tab-2" href="#">Men</a></li>
            ...
            <div class="fr-pop-tab-cont">
                        ...
                        @foreach ($featured_products['all'] as $product)
                            <li class="prod-i">
                                <div class="prod-i-top">
                                    @php
                                        $img_path = 'http://placehold.it/277x250';
                                        $img_alt = 'unknown-image';
                                        if (sizeof($product->productImages) > 0 && $product->productImages[0]->path != null && file_exists (public_path ('resources/img/product/' . $product->productImages[0]->path)))
                                        {
                                    ...
                                    <p class="prod-i-addwrap">
                                        <a href="{{ route('addToCart', $product->id) }}" class="prod-i-add">Add to cart</a>
                                    </p>
                ...
                <p data-frpoptab-num="2" class="fr-pop-tab-mob" data-frpoptab="#frpoptab-tab-2">Men</p>
                <div class="flexslider prod-items fr-pop-tab" id="frpoptab-tab-2">

                    <ul class="slides">

                        @foreach ($featured_products['men'] as $product)
                            <li class="prod-i">
                                <div class="prod-i-top">
                                    @php
                                        $img_path = 'http://placehold.it/277x250';
                ...
                <div class="flexslider prod-items fr-pop-tab" id="frpoptab-tab-3">
                    ...
                    <ul class="slides">
                        ...
                        @foreach ($featured_products['women'] as $product)
                            <li class="prod-i">
                                <div class="prod-i-top">
                                    @php
                                        $img_path = 'http://placehold.it/277x250';
                    ...
                    <ul class="slides">
                        ...
                        <li class="prod-i">
                            <div class="prod-i-top">
                                ...
                                <p class="prod-i-addwrap">
                                    <a href="product/detail/1" class="prod-i-add">Go to detail</a>
                                </p>
                            </div>
                            <h3>
                            ...
                            <div class="prod-i-skuwrapcolor">
                                <ul class="prod-i-skucolor">
                                    <li class="bx_active"><img src="resources/img/color/red.jpg" alt="Red"></li>
                                    <li><img src="resources/img/color/blue.jpg" alt="Blue"></li>
                                </ul>
                            </div>
                        </li>
                        <li class="prod-i">
                ...
                @foreach ($blogs as $blog)
                    <div class="posts-i">
                        <a class="posts-i-img" href="#">
                            @php
                                $img_path = (!file_exists (public_path ('resources/img/blog/' . $blog->image)))
                                        ? 'background: url(http://placehold.it/354x236)'
                                        : 'background: url(resources/img/blog/' . $blog->image . ')';
                            @endphp
                            <span style="{{ $img_path }}"></span>
                        </a>
                        @if ($blog->created_at != null)
                            <time class="posts-i-date" datetime="{{ $blog->created_at }}"><span>{{ $blog->created_at->isoFormat('D') }}</span> {{ $blog->created_at->isoFormat('MMM') }}</time>
                        @endif
                        <div class="posts-i-info">
                            <a href="#" class="posts-i-ctg">{{ $blog->category }}</a>
                ...
                <div class="prod-cont">
                    ...
                    <div class="prod-skuwrap">
                        ...
                        <ul class="prod-skucolor">
                            <li class="active">
                                <img src="resources/img/color/blue.jpg" alt="">
                            </li>
                            <li>
                                <img src="resources/img/color/red.jpg" alt="">
                            </li>
                            <li>
                                <img src="resources/img/color/green.jpg" alt="">
                            </li>
                            <li>
                                <img src="resources/img/color/yellow.jpg" alt="">
                            </li>
                            <li>
                                <img src="resources/img/color/purple.jpg" alt="">
                            </li>
                        </ul>
